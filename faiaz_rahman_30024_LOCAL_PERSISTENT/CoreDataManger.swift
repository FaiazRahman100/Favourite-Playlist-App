...
class CoreDataManager {
   ...
   // var count = 0
    ...
    func loadItemsThirdVC(albumName: String) -> [Songs]?{
        
        let predicateX = NSPredicate(format: "parent.name MATCHES %@", albumName)
